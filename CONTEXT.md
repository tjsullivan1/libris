...
**Near Match**:
A Book Note by the same author that the Library may already hold for the Book a Surface is
about to add. Offered to a person, never acted on alone: confirming one prevents a write and
